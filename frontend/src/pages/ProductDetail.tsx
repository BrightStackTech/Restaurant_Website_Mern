            ...
            {product.halfPrice && (
              <div className="mb-4">
                <label className="relative inline-flex items-center cursor-pointer">
                  ...
                  />
                  <div className="flex items-center bg-gray-300/90 dark:bg-gray-700/90 backdrop-blur-sm rounded-full relative shadow-sm border border-gray-700/50 dark:border-gray-600/50 w-[110px] h-[35px]">
                    <div
