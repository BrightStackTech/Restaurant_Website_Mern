      ...
      <section className="relative h-screen flex items-center">
        ...
        >
          <div className="flex items-center">
            <svg 
              className="md:w-8 md:h-8 w-6 h-6 text-white hover:text-gray-900 transition-all duration-300 group-hover:w-4 group-hover:h-4 group-hover:mr-2 animate-bounce" 
              fill="none" 
              strokeLinecap="round" 
